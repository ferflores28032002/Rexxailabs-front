            ...
            <div className="relative flex items-center px-6 py-6 sm:py-8 lg:mt-0">
              ...
              <div className="text-center relative mx-auto max-w-sm">
                <h3 className="font-semibold text-gray-900 dark:text-white uppercase">
                  con Rexxailabs, cada producto importa. Organiza, supervisa y alcanza
                  tus metas con facilidad.
                </h3>
                <p className="mt-2 text-sm text-muted-foreground">
                  Haz que cada producto cuente con Rexxailabs y alcanza tus metas
                  fácilmente.
                  <Link
                    href="/login"
        ...
        <div className="py-10 md:flex md:items-center md:justify-between">
          <div className="text-center md:text-left">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Rexxailabs todos los derechos
              reservados.
            </p>
          </div>
